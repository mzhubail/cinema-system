...
@php
  ...
  $r = round($rating, 0);
  $has_half = $r & 1;
  $stars_count = round($r / 2, 0) - $has_half;
  $empties_count = 5 - $stars_count - $has_half;
  // dd($stars_count, $has_half, $empties_count);
@endphp
...
<div class="d-flex align-items-center">
  ...
  @for ($i = 0; $i < $stars_count; $i++)
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="{{ $color }}" class="bi bi-star-fill"
      viewBox="0 0 16 16">
      <path
  ...
  @for ($i = 0; $i < $empties_count; $i++)
    {{-- Empty star --}}
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="{{ $color }}" class="bi bi-star"
      viewBox="0 0 16 16">
      <path
